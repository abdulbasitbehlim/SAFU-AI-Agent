"""
core/audio_devices.py — pick which microphone and which speakers SAFU uses.
...
WHY
    ...
    "SAFU can't hear me" almost always means "SAFU is listening to the
...
WHY THIS IS CACHED
    ...
    milliseconds on a Windows machine with many endpoints. A previous release learned this
    lesson the expensive way — an expensive speech-engine import on the Qt thread can make the
    settings drawer look broken. So the list is
