...
class ProactiveEngine:
    """
    Decides when SAFU should speak unprompted and builds a context-rich prompt.
    ...
    Improvements over 1.0:
      ...
      - Smarter silence gate    (doesn't fire while SAFU is speaking)
    ...
    def build_prompt(
        ...
        return "\n".join([
            ...
            "",
            "Rules:",
            "- Speak English only, regardless of the language in the recent conversation or memory.",
