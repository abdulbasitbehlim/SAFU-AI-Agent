"""
Screen & webcam capture for SAFU vision.
...
# OpenCV is intentionally lazy-loaded. Importing cv2 at Safu startup can add
# tens of megabytes of RAM even when the camera is never used.
cv2 = None
_CV2: bool | None = None
...
def _capture_camera() -> tuple[bytes, str]:
    if not _ensure_cv2():
        raise RuntimeError("OpenCV (cv2) is not installed. Run: python setup.py --full")
